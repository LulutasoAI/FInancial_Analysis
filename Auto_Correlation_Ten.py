...
class LRshift_N():
    ...
    def convert_four_data_to_numpy_array(self,X_train, X_test,Y_train, Y_test):
        return np.array(X_train),np.array(X_test),np.array(Y_train),np.array(Y_test)

    def learning2(self,X_train, X_test, Y_train, Y_test):
        print("calledlearning2")
        model= LinearRegression()
        X_train, X_test, Y_train, Y_test = self.convert_four_data_to_numpy_array(X_train, X_test, Y_train, Y_test)
    ...
    def dataupdate(self,today,predicted):
        ...
        #print(predicted.shape,"shapy",predicted[0][0])
        temp_list.insert(0,predicted[0][0])
